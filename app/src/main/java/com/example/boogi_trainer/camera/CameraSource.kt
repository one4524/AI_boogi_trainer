...
package com.example.boogi_trainer.camera
...
import com.example.boogi_trainer.VisualizationUtils
import com.example.boogi_trainer.YuvToRgbConverter
import kotlinx.coroutines.suspendCancellableCoroutine

import com.example.boogi_trainer.data.Person
import com.example.boogi_trainer.ml.MoveNetMultiPose
import com.example.boogi_trainer.ml.PoseClassifier
import com.example.boogi_trainer.ml.PoseDetector
import com.example.boogi_trainer.ml.TrackerType
import java.util.*
...
class CameraSource(
    ...
    companion object {
        private const val PREVIEW_WIDTH = 640    // default = 640
        private const val PREVIEW_HEIGHT = 480   // default = 480
    ...
    private fun visualize(persons: List<Person>, bitmap: Bitmap) {
        ...
        surfaceCanvas?.let { canvas ->
            ...
            canvas.drawBitmap(
                rotatedOutputBitmap, Rect(0, 0, rotatedOutputBitmap.width, rotatedOutputBitmap.height),
